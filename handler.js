...
global.dfail = (type, m, conn) => {
  let msg = {
    rowner: 'Este comando solo puede ser utilizado por el _*Creador!1!1!*_',
    owner: 'Este comando solo puede ser utilizado por _*Bot Creado*_!',
    mods: 'Este comando solo puede ser utilizado por _*Moderador*_ !',
    premium: 'Este comando solo pueden ser utilizado por miembros _*Premium*_ !',
    group: 'Este comando solo se puede usar en grupos!',
    private: 'Este comando solo se puede usar en chats privados!',
    admin: 'Este comando es solo para el grupo *Admin*!',
    botAdmin: 'Haga que el bot sea *Admin* para que use este comando !',
